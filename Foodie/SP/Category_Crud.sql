...
/****** Object:  StoredProcedure [dbo].[Category_Crud]    Script Date: 08-01-2025 08:22:51 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	IF @Action = 'INSERT'
		BEGIN 
			INSERT INTO dbo.Categories(CategoryName , ImageUrl, IsActive, CreatedDate)
			VALUES (@CategoryName, @ImageUrl, @IsActive, GETDATE())
		END
	...
	IF @Action = 'UPDATE'
		BEGIN 
			...
			ELSE
				BEGIN
					UPDATE dbo.Categories
					SET CategoryName = @CategoryName, ImageUrl = @ImageUrl, IsActive = @IsActive
					WHERE CategoryId = @CategoryId
				END
		END
