                        ...
                        <ItemTemplate>
                            <div class="item" >
                                <div class="box" style="display: flex; justify-content: space-between;">
                                    <div class="detail-box">
                                        <p style="font-size: 20px"><%# Eval("review") %></p>
                                        <h6><%# Eval("name") %></h6>
                                        <p><%# Eval("address") %></p>
                                        <h6 style="font-size: 15px"><%# Eval("postedOn") %></h6>

                                        <div class="img-box" style="margin-left: 10px;">
                                            <img style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;" class="box-img" src="<%# Utils.GetImageUrl(Eval("ImageUrl")) %>" alt="">
                                        </div>
                                    </div>
                                    <%--<div class="img-box" style="margin-left:10px">
                                        <img style="width:100px; height:100px; object-fit:cover; border-radius:50%" class="box-img" 
                                            src="<%# Utils.GetImageUrl(Eval("ImageUrl")) %>" alt="">
                                    </div>--%>
                                </div>
                            </div>
                        </ItemTemplate>
