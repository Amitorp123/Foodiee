                                            ...
                                            <div>
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:HiddenField ID="hndId" runat="server" Value="0" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                            ErrorMessage="Quantity must be no negative" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:DropDownList ID="ddlCategories" CssClass="form-control" runat="server" DataTextField="CategoryName"
                                                            DataValueField="CategoryId" DataSourceID="SqlDataSource1" AppendDataBoundItems="true">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FoddieConnectionString %>"
                                                            ProviderName="<%$ ConnectionStrings:FoddieConnectionString.ProviderName %>"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                        CssClass="badge bg-danger" CommandArgument='<%#Eval("ProductId") %>' CausesValidation="false"
